      ...
      $(document).click(function() {
        ...
        setInterval(
            function(){
              ...
              $("[id*='YouTime'][style*='background: #339900'][style*='background: rgb(51,153,0)']").css("background", "rgba(0,0,0,0)")
              $("[id*='YouTime'][style*='background: #ffdede'][style*='background: rgb(255,222,222)']").css("background", "rgba(0,0,0,0)")
            }, 50);
      });
    }, 500);
